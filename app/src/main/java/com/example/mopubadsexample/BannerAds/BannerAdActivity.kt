...
class BannerAdActivity : AppCompatActivity() {
    ...
    private fun initAds() {
        ...
        moPubBanner.adUnitId = Constant.MoPub.BANNER_AD_UNIT
        moPubBanner.loadAd()
        ...
        switch_banner_btn.setOnClickListener {
            if (!isMediumRectangleAd) {
                ...
                moPubBanner.adUnitId = Constant.MoPub.MEDIUM_RECT_AD_UNIT //Ad Unit for Medium Rectangle Ad (300x250)
                moPubBanner.loadAd()
                switch_banner_btn.text = "Show Banner Ad"
            } else {
                isMediumRectangleAd = false
                moPubBanner.adUnitId = Constant.MoPub.BANNER_AD_UNIT //Ad Unit for Banner Ad (320x50)
                moPubBanner.loadAd()
